<?
	...
	$consulta ="select descripcion,n_sucursal, n_factura, razon_social, talonario, observacion, cod_talonario  FROM
						...
						where fecha = $fecha_buscar and cod_repartidor = $repartidor and observacion <> 'ANULADO' and producto.envase = 'SI' GROUP BY factura_vta_no_cliente.n_factura 
					...
					UNION
						...
						where fecha = $fecha_buscar and cod_repartidor = $repartidor and observacion <> 'ANULADO'  and producto.envase = 'SI' GROUP BY factura_vta.n_factura 
	...
	if($nfilas > 0){
		...
		echo "<table width='100%'  border='0'cellspacing='1' cellpadding='0'>";
			...
			do{ 		// obtengo los resultados 
						...
						include("informe_resumen_envases_deposito2.php");
