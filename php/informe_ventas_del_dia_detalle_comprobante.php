...
if($cod_tal){
	...
	echo "<div  align='right' class='seccion'>";
		echo "<img src='../imagenes/pdf.gif' width='18' height='18' border='0' class='iconos'  title='Exportar' onClick=\"javascript: exportar_listado_venta_del_dia_detalle_comprobante('exportar_informe_ventas_del_dia_detalle_comprobante.php')\" /> pdf  &nbsp;&nbsp;<img src='../imagenes/imprimir.png' width='18' height='18' title='Imprimir' class='iconos' onClick=\"javascript: imprimir_listado_venta_del_dia_detalle_comprobante('exportar_informe_ventas_del_dia_detalle_comprobante.php')\" /> imprimir";
	echo "</div>";
