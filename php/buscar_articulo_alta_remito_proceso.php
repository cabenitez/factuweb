<?
		if($nombre == "TODOS"){
			$pag_consulta = "select cod_grupo, cod_marca, cod_variedad, cod_prod, descripcion,stock_actual from producto where  activo = 'S' group by cod_grupo, cod_marca, cod_variedad, cod_prod order by cod_grupo";
		}else{
