...
if($fecha_buscar){
	...
	if($filas > 0){
			echo "<div  align='right' class='seccion'>";
				echo "<img src='../imagenes/pdf.gif' width='18' height='18' border='0' class='iconos'  title='Exportar' onClick=\"javascript: exportar_listado_venta_del_dia('exportar_informe_ventas_del_dia.php')\" /> pdf  &nbsp;&nbsp;<img src='../imagenes/imprimir.png' width='18' height='18' title='Imprimir' class='iconos' onClick=\"javascript: imprimir_listado_venta_del_dia('exportar_informe_ventas_del_dia.php')\" /> imprimir";
			echo "</div>";
			echo "<br>";
			//---------------------abre la tabla--------------------------------------------------------------------------------------//
				...
				do{ 					// obtengo los resultados 
						...
						echo "<tr onMouseOver=color_seleccion(this,'E0E0E0'); onMouseOut=color_defecto(this,'EAEAEA'); bgcolor='#EAEAEA'>"; //efecto ded color en las filas
							...
							echo "<td $clase align='center'>";
									echo "<img  class='iconos' src='../imagenes/detalle.gif' border='0' title='Ver detalle' onClick='javascript:  			    buscar_venta_dia_detalle($repartidor)'>"; 
							echo"</td>";
	...
	$smarty->display('informe_ventas_del_dia.tpl');   //define la plantilla que utilizara
}
?>
