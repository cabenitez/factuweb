...
DEFINE("DEFAULT_GFORMAT","auto");	//             DEFINE ("DEFAULT_GFORMAT" ,"auto");          $graph-> img-> SetImgFormat( "jpeg")
...
// si es true puede traer conflictor a la ora de mostrar por que no se refresca
...
//defino el path del cache, asi como esta lo ubica en la raiz de la unida: "c:/tmp" y crea un dir llamado "jpgraph_cache"
DEFINE( "CACHE_DIR", "/tmp/jpgraph_cache/");
?>