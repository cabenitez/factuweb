...
include("conexion.php");
	...
	$consulta = "SELECT n_factura, cod_talonario, num_talonario FROM factura_vta inner join forma_pago on forma_pago.cod_fp = factura_vta.cod_fp 
					WHERE (factura_vta.observacion <> 'ANULADO' and factura_vta.observacion <> 'N/C' 
					and factura_vta.cod_cliente = $codigo 
					and factura_vta.cod_zona = $cod_zona 
					and factura_vta.cod_localidad = $cod_localidad 
					and factura_vta.cod_prov = $cod_prov 
					and factura_vta.cod_pais = $cod_pais) 
					and (forma_pago.descripcion LIKE '%CTA%' or forma_pago.descripcion like '%CUENTA%' 
	...
	if ($nfilas > 0){     						 		// si existe el usuario inicia la sesion
		...
		echo "<table width='100%'  border='0'cellspacing='1' cellpadding='0'>";
		    echo "<tr>";
				echo"<td height='47' colspan='2' align='left'  class='seccion'valign='top'>Imputaci&oacute;n de Comprobantes <hr></td>";
			echo "</tr>";
			echo "<tr class='top'>";
				//echo "<td width='3%' ><div align='center' class='seccion'>IMPUTAR</div></td>";
				echo "<td width='5%' ><div align='center' class='seccion'>N&deg; TAL.</div></td>";
				echo "<td width='57%' ><div align='center' class='seccion'>COMPROBANTE</div></td>";
		...
		do{
				...
				$consulta2 = "SELECT fecha, descripcion, n_sucursal, SUM(round(total_general,2)), cod_talonario, num_talonario, n_factura
							  FROM(
									...
									where cliente.cod_cliente = $codigo 
										...
										and factura_vta.cod_prov=$cod_prov 
										and factura_vta.cod_pais = $cod_pais 
										and factura_vta.observacion <> 'ANULADO' 
										and factura_vta.observacion <> 'N/C' 
										and factura_vta.cod_talonario='$cod_talonario' 
										and factura_vta.num_talonario=$num_talonario 
				...
				//echo $nfilas2 = mysql_num_rows ($result2);          		   //indica la cantidad de resultados
				//echo '-'.$n_factura.'-'.$num_talonario; 
				...
				//do{
						...
						if($saldo > 0 ){
								...
								echo "<tr  onMouseOver=color_seleccion(this,'E0E0E0'); onMouseOut=color_defecto(this,'EAEAEA'); bgcolor='#EAEAEA'>"; //efecto ded color en las filas
									...
									echo "<td $clase align='center'>";
											if($saldo != $importe ){
													echo "<img  class='iconos' src='../imagenes/detalle.gif' border='0' title='Ver composici&oacute;n de saldos' onClick='javascript: buscar_composicion_saldo_detalle(\"$cod_talonario\",$num_talonario,\"$n_f\",\"$desc_fac\",$suc)'>"; 
											}
									echo"</td>";
									echo "<td $clase align='center'>";
											?>
				...
				echo"<tr bgcolor='#E0E0E0' >";			
					echo"<td colspan='3' align='left'>&nbsp;&nbsp;TOTALES	</td>";
