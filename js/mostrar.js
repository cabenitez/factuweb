...
if (typeof ol_height == 'undefined') { var ol_height = 120; }
...
function overlib(a,s,d,s,g) {
	...
	o3_fixx = ol_fixx;
	o3_fixy = ol_fixy;
	o3_fgbackground = g;/*ol_fgbackground;   /*  imagen en el cuerpo*/
	o3_bgbackground = ol_bgbackground;              /* imagen en la cabezera */
	o3_padxl = ol_padxl;
	o3_padxr = ol_padxr;
	o3_padyt = ol_padyt;
	o3_padyb = ol_padyb;
...
// Caption popup
function dtc(d,text,title,imagen) {
	o3_hpos = vpos_convert(d);
	overlib(text,CAPTION, title, o3_hpos,imagen);
}
...
// Caption popup right
function drc(text,title,imagen) {
	dtc(1,text,title,imagen);
}
