...
$importe_cliente_total_sin_impuesto = " -- CASE factura_vta.cod_talonario
										...
										-- 			round(((sum(cantidad * precio)- sum(((cantidad * precio)* bonificacion)/100))*factura_vta_detalle.iva)/100,2) +  /*IVA*/
...
$importe_no_cliente_total_sin_impuesto = "-- CASE factura_vta_no_cliente.cod_talonario
											...
											-- 			,
											-- 			(round(sum(cantidad * precio)- sum(((cantidad * precio)* bonificacion)/100),2) +  /*NETO*/
											-- 			round(((sum(cantidad * precio)- sum(((cantidad * precio)* bonificacion)/100))*factura_vta_no_cliente_detalle.iva)/100,2) +  /*IVA*/
											-- 			round((round(sum(cantidad * precio)- sum(((cantidad * precio)* bonificacion)/100),2) + 
