...
while($registro = mysql_fetch_array($result)){ 					// obtengo los resultados 
				$pdf->Cell(0,3 ,$registro[0],0,0); 				// nombre=;
				$pdf->SetX(40);
				$pdf->Cell(0,3 ,$registro[2],0,0); 				// nombre=;
				$pdf->SetX(105);
				$pdf->Cell(0,3 ,$registro[3],0,0); 				// nombre=;
				$pdf->SetX(130);
				$pdf->Cell(0,3 ,$registro[4],0,1); 				// nombre=;
				$pdf->SetX(6);
