...
if($cod_cliente){ 
	...
	if($impresora_fiscal == 1){			    // si se definio la impresora fiscal
		$array_fiscal[$i_fiscal++] = "@PONEENCABEZADO|5|SFyCSOL REMITO";
		...
		$array_fiscal[$i_fiscal++] = "@FACTABRE|E|C|X|1|P|12|I|F|JUAN PEREZ||CUIT|27141670641|N|BELGRANO 970|||REMITO 1||C"
		
		$array_fiscal[$i_fiscal++] = "@FACTABRE|E|C|X|$cant_copias|F|10|I|I|$razon||$cuit_fiscal|N|$dir|||$remito_fiscal||C";
	}
	*/
	//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\
	//\\//\\//\\//\\//\\//\\//\\ FISCAL //\\//\\//\\//\\//\\//\\//\\//\\//\\//\\
  ...
  include("imprimir_remito.php");	 						// Incluye la pagina para imprimir las facturas
...
}else{ // nuevo remito - obtiene los parametros *******************************************************
	$consulta = "call vaciar_tabla_rem_vta_tmp('$usuario_rem')";			//	vacia la tabla temporal
	mysql_query($consulta);            										// hace la consulta
	...
	//$smarty->display('alta_remito_vta.tpl'); //define la plantilla que utilizara
	
	//=============CONTROL DE PERMISO PARA EL ACCESO AL MODULO=============//
	$modulo="remito_vta";
	$plantilla = "alta_remito_vta.tpl";
