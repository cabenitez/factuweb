...
if($fecha_buscar){
	...
	if($filas > 0){
			echo "<div  align='right' class='seccion'>";
				echo "<img src='../imagenes/pdf.gif' width='18' height='18' border='0' class='iconos'  title='Exportar' onClick=\"javascript: exportar_informe_detalle_comprobante('exportar_informe_detalle_comprobante.php')\" /> pdf  &nbsp;&nbsp;<img src='../imagenes/imprimir.png' width='18' height='18' title='Imprimir' class='iconos' onClick=\"javascript: imprimir_informe_detalle_comprobante('exportar_informe_detalle_comprobante.php')\" /> imprimir";
			echo "</div>";
			echo "<br>";
	...
	$smarty->display('informe_detalle_comprobante.tpl');   //define la plantilla que utilizara
}
?>
