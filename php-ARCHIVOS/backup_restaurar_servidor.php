...
if ($listar == 1){
	$ruta = "./back_up/generados/";						// variable con la cadena q indica la ruta
	...
	if($cant_archivos > 0 ){
		echo "<form  name='frm_restaurar'>";
			...
			echo "<tr class='top'>";
				...
				echo "<td width='10%'><div align='center' class='seccion'>Restaurar</div></td>";
			echo "</tr>";
					...
					if ($archivo != "." && $archivo != "..") { 
						...
						echo "<tr onMouseOver=color_seleccion(this,'E0E0E0'); onMouseOut=color_defecto(this,'EAEAEA'); bgcolor='#EAEAEA'>"; //efecto ded color en las filas
							...
							echo "<td $clase align='right'>";
									echo number_format(filesize($ruta.$archivo)/1024/1024,2,'.','') . ' MB' . $espacio_izq;
							echo"</td>";
							echo "<td $clase align='center'>";
									echo "<input name='enviar' type='button' class='botones' id='enviar' onclick='javascript: restaurar_base_datos_servidor(\"$ruta$archivo\")'  value='Restaurar'>";
							echo"</td>";						
	...
	$modulo="utilidades";
	$plantilla = "backup_restaurar_servidor.tpl";
