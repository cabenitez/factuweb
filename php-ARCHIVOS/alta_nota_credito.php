...
if($razon){ 
	...
	if ($nfilas == 0){     						 // si existe el usuario inicia la sesion
				...
				$obs = "N/C"; //= $_POST["obs"]; 					// toma la variable de la url q vino de ajax.js
				...
				//***********************************************************************************************************//	
						...
						if($result = mysql_query($consulta)){        // hace la consulta
							...
							if($impresora_fiscal == 1){			    // si se definio la impresora fiscal
								$array_fiscal[$i_fiscal++] = "@PONEENCABEZADO|5|SFyCSOL N/C $codigo_tal";
								...
								$array_fiscal[$i_fiscal++] = "@FACTABRE|N|C|$codigo_tal|$cant_copias|F|10|$cond_iva_fiscal_empresa|$cond_iva_fiscal_cliente|$razon||$cuit_fiscal|N|$dir|||$remito_fiscal||C";
							}
							//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\
							//\\//\\//\\//\\//\\//\\//\\ FISCAL //\\//\\//\\//\\//\\//\\//\\//\\//\\//\\
							//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\
						  ...
						  if($codigo_tal == 'X'){
							  ...
							  include("imprimir_nota_credito.php");	 						// Incluye la pagina para imprimir las facturas
						  }
	...
	//$smarty->display('alta_nota_credito.tpl');   //define la plantilla que utilizara
	
	//=============CONTROL DE PERMISO PARA EL ACCESO AL MODULO=============//
	$modulo="nota_credito";
	$plantilla = "alta_nota_credito.tpl";
