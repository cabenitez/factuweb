...
if($cod_tal){
	...
	//---------------------abre la tabla--------------------------------------------------------------------------------------//
	echo "<br>";
	echo "<div  align='center' class='seccion'><b><u>IMPUTACION DE COBRANZAS</u></b></div>";
	...
	echo "<div  align='right' class='seccion'>";
		echo "<img src='../imagenes/pdf.gif' width='18' height='18' border='0' class='iconos'  title='Exportar' onClick=\"javascript: exportar_imputacion_cobranza_cliente('exportar_imputacion_cobranza_cliente.php')\" /> pdf  &nbsp;&nbsp;<img src='../imagenes/imprimir.png' width='18' height='18' title='Imprimir' class='iconos' onClick=\"javascript: imprimir_imputacion_cobranza_cliente('exportar_imputacion_cobranza_cliente.php')\" /> imprimir";
	echo "</div>";
	...
	echo "<table width='100%'  border='0'cellspacing='1' cellpadding='0'>";
		...
		echo "<tr class='top'>";
			...
			echo "<td width='30%'><div align='center' class='seccion'>OBSERVACION</div></td>";
			echo "<td width='29%'><div align='center' class='seccion'>IMPUTADO POR</div></td>";
			  ...
			  //----------------------------------------------------------------------------------------------------------------//
				...
				echo "<tr onMouseOver=color_seleccion(this,'E0E0E0'); onMouseOut=color_defecto(this,'EAEAEA'); bgcolor='#EAEAEA'>"; //efecto ded color en las filas
					echo "<td $clase align='left'>";
							echo $espacio_izq.$num_tal_f;     
					echo"</td>";
					echo "<td $clase align='left'>";
							echo $espacio_izq.$desc_f.' '.$suc_f.' '.$n_f;     
					echo"</td>";
					echo "<td $clase align='left'>";
