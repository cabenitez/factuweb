...
if($cod_tal){
	...
	//---------------------abre la tabla--------------------------------------------------------------------------------------//
	echo "<br>";
	echo "<div  align='center' class='seccion'><b><u>COMPOSICION DE SALDOS</u></b></div>";
	...
	echo "<table width='100%'  border='0'cellspacing='1' cellpadding='0'>";
		...
		echo "<tr class='top'>";
			...
			echo "<td width='8%'><div align='center' class='seccion'>FECHA</div></td>";
			echo "<td width='7%'><div align='center' class='seccion'>IMPORTE</div></td>";
			echo "<td width='7%'><div align='center' class='seccion'>OBSERVACION</div></td>";
			echo "<td width='7%'><div align='center' class='seccion'>IMPUTADO POR</div></td>";
		echo "</tr>";
