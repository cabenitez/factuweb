...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
	...
	<div align="left"> Modificar Categoria <hr width="100%"> </div></td>
  </tr>
  <tr>
        ...
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFBFBF">
          ...
          <tr>
            ...
            <td width="151" align="left"valign="top">
              <input name="nombre_mod" id="nombre_mod" type="text" class="caja" size="27" onKeyUp="pasar_foco_cat_mod(event)" value="{$nombre}" >
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar_mod" type="button" class="botones" id="enviar_mod" onclick="javascript: modificar_categoria_db()"  value="Modificar">
                <input name="cancelar_mod" type="button" class="botones" id="cancelar_mod" onclick="javascript: buscar_categoria()"  value="Cancelar">
            </div></td>
            <td width="18" valign="top">&nbsp;</td>
          </tr>
        </table></td>
