...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
	...
	<div align="left"> Modificar Condici&oacute;n de IVA <hr width="100%"> </div></td>
  </tr>
  <tr>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          <tr>
            <td width="76" height="19" rowspan="6" valign="top"><span class="DDD"><img src="../imagenes/18.jpg" width="18" height="18" /></span></td>
          ...
          <tr>
            <td width="484" valign="top"><div align="left">Nombre:
            </div></td>
            <td width="385" align="left"valign="top">
              <!-- <input name="nombre_mod" id="nombre_mod" type="text" class="caja" size="27" onKeyUp="pasar_foco_cond_iva_4(event)" value="{$nombre}" > -->
			  <div id="nomb_mod"></div>
			</td>
            <td width="64" rowspan="2" valign="top">&nbsp;</td>
          </tr>
          <tr>
            <td width="484" valign="top">Comprobante:</td>
            <td align="left"valign="top"><div id="comp_mod"></div></td>
          </tr>
          <tr>
            <td valign="bottom">Requiere N&ordm; CUIT: </td>
            <td valign="bottom"><div id="req_cuit_mod"></div></td>
            <td valign="top">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar_mod" type="button" class="botones" id="enviar_mod" onclick="javascript: modificar_cond_iva_db()"  value="Modificar">
                <input name="cancelar_mod" type="button" class="botones" id="cancelar_mod" onclick="javascript: buscar_cond_iva()"  value="Cancelar">
            </div></td>
