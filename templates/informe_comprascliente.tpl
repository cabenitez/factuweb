...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Compras por Cliente
        <hr>
    </div></td>
      ...
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <tr>
			...
			<input name="razon" type="text" class="caja" id="razon" onKeyUp="informe_compras_cliente_2(event)" size="29" ></td>
            <td valign="top"></td>
          </tr>
          <tr>
  ...
  <input name="ano_h" type="text" class="caja" id="ano_h"onKeyUp="pasar_foco_iva_ventas_6(event)" onKeyPress="return solo_entero(event)"value="" size="4" maxlength="4">
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="buscar" type="button" class="botones" id="buscar" onClick="javascript: buscar_compras_cliente()"  value="Buscar">
</div></td>
