...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0"><!--DWLayoutTable--> 
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"> <div  align="left">Seccion: Alta de Factura Venta<hr></div></td>
...
<!-- 	<img src="../imagenes/nuevo2.gif" width="16" height="18" border="0" class='iconos'  title="Nuevo... (ESC)" onClick="javascript: window.opener.document.getElementById('principal').src ='alta_factura_vta.php';" /> nuevo &nbsp;&nbsp; 	
  --><img src="../imagenes/imprimir.png" width="18" height="18" title="Imprimir Factura... (F9)" class='iconos'  onClick="javascript: registrar_factura_vta();" /> imprimir <!-- onClick="javascript: registrar_factura_vta();" -->
      ...
      <tr>
		...
		<table width="100%" border="0" align="left" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <tr>
            ...
            <td width="129"  align="left" valign="bottom" class="seccion"><div id="numero_tal"> 0000</div> <input type="hidden"  id="oculto_numero_tal"  name="oculto_numero_tal" >
            ...
            <td width="139"  align="left"valign="bottom"><input  name="remito" type="text"class="select_1"  id="remito" onKeyPress="return solo_entero(event)" onKeyUp="buscar_remito_alta_factura_vta(event)" size="8" maxlength="8">
            ...
            <td width="154" align="left"valign="bottom"><input  name="codigo"type="text"class="select_1"  id="codigo" onKeyPress="return solo_entero(event)" onKeyUp="buscar_cliente_alta_fact_vta(event)" value="" size="5" maxlength="5">
				  ...
				  <tr>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
					  ...
					  <tr>
						...
						<td width="144" align="left" valign="bottom"><div id="importe_art" class="seccion">0.00</div><input type="hidden"  id="oculto_importe_art"  name="oculto_importe_art"></td>
