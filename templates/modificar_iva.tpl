...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
	...
	<div align="left"> Modificar IVA <hr width="100%"> </div></td>
  </tr>
  <tr>
        ...
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <tr>
            ...
            <td width="151" align="left"valign="top">
              <input name="nombre_mod" id="nombre_mod" type="text" class="caja" size="27" onKeyUp="pasar_foco_iva_4(event)" value="{$nombre}" >              </td>
            <td width="18" rowspan="2" valign="top">&nbsp;</td>
          </tr>
          <tr>
            <td width="12" valign="top">Tasa:</td>
            <td align="left"valign="top"><input name="tasa_mod" type="text" class="caja" id="tasa_mod"  onKeyPress="return solo_entero(event)" value="{$tasa}"onKeyUp="pasar_foco_iva_5(event)" size="5" maxlength="5" >
              %</td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar_mod" type="button" class="botones" id="enviar_mod" onclick="javascript: modificar_iva_db()"  value="Modificar">
                <input name="cancelar_mod" type="button" class="botones" id="cancelar_mod" onclick="javascript: buscar_iva()"  value="Cancelar">
            </div></td>
