...
<center>
<body  leftmargin="0" topmargin="0"  marginheight="0" marginwidth="0" onLoad="javascript: listar_anos_comerciales();">
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Ranking de Ventas Mensuales
        <hr>
    </div></td>
...
<fieldset  style="width:15%; height:10%;">
      ...
      <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <tr>
			...
			<div align="left">Año:</div>			</td>
            <td width="628" align="left" valign="bottom"><div id="anos"></div></td>
          ...
          <tr>
            ...
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="buscar" type="button" class="botones" id="buscar" onclick="javascript: buscar_ranking_ventas_anuales()"  value="Buscar">
