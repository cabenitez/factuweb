...
<table width="100%" height="100%"   border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="100%" height="21" class="seccion" valign="top"><div align="left">Seccion: Informe DGR<hr></div></td>
  </tr>
	...
	<fieldset  style="width:49%; height:100%;">
			<div id="mensage" class="advertencia"></div>
				 <table align="left" width="100%"    border="0" cellpadding="0" cellspacing="0"> 
					<tr>
						<td width="25%">
							<input name="enviar"  align="left" type="button" class="botones" id="enviar" onclick="javascript: generar_archivos_txt_DGR('F129')"  value="Generar Form Nº129" >
						</td>
						<td><div id="div_F129"></div></td>
					</tr>
		</table>
	</fieldset>
	</td>
