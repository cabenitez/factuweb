...
<center>
<body  leftmargin="0" topmargin="0"  marginheight="0" marginwidth="0" onLoad="javascript: document.frm.codigo.focus();buscar_grupo(); "> 
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Alta de Grupo
      <hr>
    </div></td>
      ...
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <tr>
            ...
            <td align="left"valign="bottom"><input name="codigo" type="text" class="caja" id="codigo" onKeyPress="return solo_entero(event)" onKeyUp="pasar_foco_grupo_1(event)" size="12" maxlength="9" ></td>
            <td valign="top">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td width="135" align="left"valign="bottom">
               <input name="nombre" id="nombre" type="text" class="caja" size="27" onKeyUp="pasar_foco_grupo_2(event)" ></td>
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar" type="button" class="botones" id="enviar" onclick="javascript: registrar_grupo()"  value="Registrar">
            </div></td>
            <td width="24" valign="top">&nbsp;</td>
          </tr>
        </table></td>
