...
<center>
<body  leftmargin="0" topmargin="0"  marginheight="0" marginwidth="0" onLoad="javascript: document.frm.nombre.focus();buscar_fp();"> 
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Alta de Forma de Pago 
        <hr>
    </div></td>
    <td width="50%" align="right" valign="top" class="seccion">
	<img src="../imagenes/lupa.jpg" width="16" height="18" border="0" class='iconos'  title="Nuevo" onClick=" window.opener.document.getElementById('principal').src ='buscar_forma_pago.php'" /> buscar &nbsp;&nbsp;
...
<td width="97" align="left" valign="bottom">
          ...
          <input name="nombre" id="nombre" type="text" class="caja" size="27" onKeyUp="pasar_foco_fp_1(event)" >                </td>
...
<td valign="top" align="left">Observacion:              </td>
          ...
          <tr>
            ...
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar" type="button" class="botones" id="enviar" onclick="javascript: registrar_fp()"  value="Registrar">
            </div></td>
