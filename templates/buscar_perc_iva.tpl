...
<center>
<body  leftmargin="0" topmargin="0"  marginheight="0" marginwidth="0" onLoad="javascript: poner_foco_pi();"> <!-- -->
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Buscar Percepción de IVA 
        <hr>
    </div></td>
    <td width="50%" align="right" valign="top" class="seccion">
	<img src="../imagenes/nuevo2.gif" width="16" height="18" border="0" class='iconos'  title="Nuevo" onClick=" window.opener.document.getElementById('principal').src ='alta_perc_iva.php'" /> nuevo &nbsp;&nbsp;
        ...
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFBFBF">
          ...
          <tr>
            ...
            <td width="186" align="left" valign="top">
                ...
                <input name="nombre" id="nombre" type="text" class="caja" size="27" onKeyUp="pasar_foco_pi_3(event)" >                </td>
          ...
          <tr>
            ...
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar" type="button" class="botones" id="enviar" onclick="javascript: buscar_pi()"  value="Buscar">
            </div></td>
