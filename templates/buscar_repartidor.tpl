...
<center>
<body  leftmargin="0" topmargin="0"  marginheight="0" marginwidth="0" onLoad="javascript: document.frm.nombre.focus();listar_vehiculo_rep_bus();">
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Buscar Repartidor 
        <hr>
    </div></td>
    <td width="50%" align="right" valign="top" class="seccion">
	<img src="../imagenes/nuevo2.gif" width="16" height="18" border="0" class='iconos'  title="Nuevo" onClick=" window.opener.document.getElementById('principal').src ='alta_repartidor.php'" /> nuevo &nbsp;&nbsp;
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <input name="nombre" type="text" class="caja" id="nombre" onKeyUp="pasar_foco_rep_11(event)" >             </td>
            <td width="31" align="left"valign="top">&nbsp;</td>
          </tr>
          <tr>
            <td valign="top" align="left"><div align="left">Veh&iacute;culo: 
              <input name="nada" type="text" class="caja" id="nada" style="visibility:hidden" size="1" maxlength="1">
            </div></td>
            <td   valign="bottom"align="left"><div  id="vehiculos"></div></td>
            <td valign="top">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar" type="button" class="botones" id="enviar" onclick="javascript: buscar_repartidor2()"  value="Buscar">
            </div></td>
