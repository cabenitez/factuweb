        ...
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <tr>
            <td colspan="6" valign="bottom"><div align="center"> 
                ...
                <!-- campo oculto-->
                <input name="enviar" type="button" class="botones" id="enviar" onclick="javascript: buscar_articulo2('buscar_articulo_proceso_lista_precios.php?')"  value="Buscar"> 
            </div></td>
