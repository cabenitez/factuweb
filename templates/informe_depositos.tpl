...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Depositos
        <hr>
    </div></td>
  ...
  <input name="ano2" type="text" class="caja" id="ano_h"onKeyUp="pasar_foco_iva_ventas_6(event)" onKeyPress="return solo_entero(event)"value="" size="4" maxlength="4">
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="buscar" type="button" class="botones" id="buscar" onClick="javascript: informe_deposito_proceso()"  value="Buscar">
</div></td>
