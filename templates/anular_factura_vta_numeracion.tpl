...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Anular Numeración Factura Venta 
        <hr>
    </div></td>
      ...
      <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <tr>
            ...
            <td width="1059" align="left" valign="bottom">
          ...
          <tr>
            ...
            <td align="left" valign="bottom">N&uacute;mero Factura desde:</td>
            <td align="left" valign="bottom"><input name="num_fac" type="text" class="caja" id="num_fac" onKeyPress="return solo_entero(event)" onKeyUp="pasar_anular_f_3_numeracion(event)" size="8" maxlength="8" ></td>
            <td valign="top"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="anular" type="button" class="botones" id="anular" onclick="javascript: anular_factura_vta_numeracion()"  value="Anular">
            </div></td>
