...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Anular Factura Venta
        <hr>
    </div></td>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <tr>
            ...
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="buscar" type="button" class="botones" id="buscar" onclick="javascript: buscar_factura_vta_anular()"  value="Buscar">

                <input name="anular" type="button" class="botones" id="anular" onclick="javascript: anular_factura_vta()"  value="Anular">
            </div></td>
