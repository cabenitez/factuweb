...
<center>
<body  leftmargin="0" topmargin="0"  marginheight="0" marginwidth="0" onLoad="javascript: poner_foco_ii();buscar_ii()"> <!-- -->
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Alta de Impuesto Interno 
        <hr>
    </div></td>
    <td width="50%" align="right" valign="top" class="seccion">
	<img src="../imagenes/lupa.jpg" width="16" height="18" border="0" class='iconos'  title="Nuevo" onClick=" window.opener.document.getElementById('principal').src ='buscar_imp_int.php'" /> buscar &nbsp;&nbsp;
        ...
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <tr>
            ...
            <td width="186" align="left" valign="top">
                ...
                <input name="nombre" id="nombre" type="text" class="caja" size="27" onKeyUp="pasar_foco_ii_1(event)" >             </td>
            <td width="22" align="left"valign="top"></td>
          </tr>
          <tr>
            <td width="27" height="0" valign="top" class="LLL"><div align="right"></div></td>
            <td valign="top" align="left"> Importe:</td>
            <td   valign="bottom"align="left">
				<input name="tasa" type="text" class="caja" id="tasa"  onKeyPress="return solo_entero(event)" onKeyUp="pasar_foco_ii_2(event)" size="5" maxlength="5" >
		  </td>
            <td valign="top">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar" type="button" class="botones" id="enviar" onclick="javascript: registrar_ii()"  value="Registrar">
            </div></td>
