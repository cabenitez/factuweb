...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0"><!--DWLayoutTable-->
  <tr>
    ...
    <td height="12" class="advertencia" colspan="2" align="center" valign="top">
		<div id="msg_mod"  class="nota"><img src="../imagenes/advertencia.gif" width="16" height="16"> ERROR: El Stock inicial ya se ha realizado, para modificarlo debe registrar una factura de compra  </div>
