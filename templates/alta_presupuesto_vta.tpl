...
<title>{#tituloPagina#}</title>
    ...
    <script language="javascript" src="../js/ajax-presupuestos.js"></script>
...
<body leftmargin="0" topmargin="0"  marginheight="0" marginwidth="0" onLoad="javascript: document.frm.remito.focus();listar_zona_fac(); listar_cond_iva_presu();listar_cat_fac();listar_forma_pago(); hora_actual(); buscar_num_presu_vta();">
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0"><!--DWLayoutTable--> 
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"> <div  align="left">Seccion: Alta de Presupuestos <hr></div></td>
...
<!-- 	<img src="../imagenes/nuevo2.gif" width="16" height="18" border="0" class='iconos'  title="Nuevo... (ESC)" onClick="javascript: window.opener.document.getElementById('principal').src ='alta_factura_vta.php';" /> nuevo &nbsp;&nbsp; 	
  --><img src="../imagenes/imprimir.png" width="18" height="18" title="Imprimir Presupuesto... (F9)" class='iconos'  onClick="javascript: registrar_presupuesto_vta();" /> imprimir <!-- onClick="javascript: registrar_factura_vta();" -->
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="100%" border="0" align="left" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <tr>
            <td width="78" align="left" valign="bottom">Talonario:</td>
            <td width="129"  align="left" valign="bottom" class="seccion"><div id="numero_tal"> 0000</div> 
            ...
            <td  align="left" valign="bottom">Presupuesto: </td>
            <td  align="left" valign="bottom" class="seccion"><div id="numero_presu">0000-00000000-X</div><input type="hidden"  id="oculto_numero_presu"  name="oculto_numero_fac" ></td>
            <td width="58"  align="left" valign="bottom" >Fecha:</td>
            <td width="122"  align="left" valign="bottom"class="seccion" >{$dia}/{$mes}/{$ano}
              <input type="hidden"  id="oculto_fecha"  name="oculto_fecha" value="{$ano}{$mes}{$dia}"></td>
            <td width="57"  align="left"valign="bottom">Hora:</td>
            <td width="76"  align="left"valign="bottom" class="seccion"><div id="hora_actual" ></div></td>
            <td width="62"  align="left"valign="bottom" >Remito:</td>
            <td width="139"  align="left"valign="bottom">
              <input  name="remito" type="text"class="select_1"  id="remito" onKeyPress="return solo_entero(event)" onKeyUp="buscar_remito_alta_presu_vta(event)" size="8" maxlength="8">
              <img src="../imagenes/seguiente.gif" width="14" height="14" class="iconos" title="Buscar Remito pendiente...     (F2)"onClick=" javascript: seleccionar_remito_presu_vta()">
            </td>
            <td width="63" align="left"valign="bottom"> Cliente: </td>
            <td width="154" align="left"valign="bottom">
              <input  name="codigo"type="text"class="select_1"  id="codigo" 
              	      onKeyPress="return solo_entero(event)" onKeyUp="buscar_cliente_alta_presu_vta(event)" value="" size="5" maxlength="5">
              <img src="../imagenes/seguiente.gif" width="14" height="14" class="iconos" title="Buscar Cliente...     (F2)"onClick=" javascript: seleccionar_cliente_presu_vta()"></td>
            </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="71" align="left" valign="bottom">CUIT:</td>
            ...
            <td align="left" valign="bottom">
              <input name="busca_pop_up" type="button" class="botones" id="busca_pop_up"  style="visibility:hidden" onClick="javascript: buscar_cliente_presu_vta()"  value="C">              <input name="busca_pop_up3" type="button" class="botones" id="busca_pop_up3"  style="visibility:hidden" onClick="javascript: buscar_remito_presu_vta()"  value=" R">
            </td>
            ...
            <td colspan="2" align="left" valign="bottom"><input type="text" id="testid" value="" style="font-size: 10px; width: 20px; visibility:hidden" disabled  /></td>
            </tr>
          <tr>
            ...
            <td width="187" align="left" valign="bottom"><input name="lugar" type="text" class="caja"  id="lugar"  onKeyUp="pasar_foco_fac_vta_11(event)" size="20" maxlength="10"></td>
            <td align="left" valign="bottom">Hora: </td>
            <td align="left" valign="bottom"><input name="hora"type="text" class="caja"  id="hora"  onKeyUp="pasar_foco_fac_vta_12(event)" size="10" maxlength="10"></td>
				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
				  <tr>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
					  <tr>
						<td height="19" colspan="12" valign="top"><div id="mensaje_art" class="advertencia"></div></td>
					  ...
					  <tr>
						...
						<td width="82" align="left" valign="bottom"><div id="precio_art" class="seccion">0.00</div><input type="hidden"  id="oculto_precio_art"  name="oculto_precio_art">						</td>
						<td width="53" align="left" valign="bottom">Cantidad:</td>
						<td width="25" align="left" valign="bottom">
                        <input name="cant_art"type="text" class="caja"  id="cant_art"  onKeyPress="return solo_entero(event)" onKeyUp="calcular_importe_presu(event)" size="5" maxlength="5"></td>
						<td width="34" align="left" valign="bottom">Bonif.:</td>
						<td width="94" align="left" valign="bottom">
                        <input name="bonif_art"type="text" class="caja"  id="bonif_art"  onKeyPress="return solo_entero(event)" onKeyUp="calcular_importe_presu(event)" size="5" maxlength="5">
						  %</td>
						<td width="45" align="left" valign="bottom">Importe:</td>
						<td width="144" align="left" valign="bottom">
                        <div id="importe_art" class="seccion">0.00</div><input type="hidden"  id="oculto_importe_art"  name="oculto_importe_art"></td>
						<td valign="top">
...
<script language="javascript" src="../js/autocompletador2.js" charset="utf-8"></script> 
