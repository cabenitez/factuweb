...
<center>
<body leftmargin="0" topmargin="0"  marginheight="0" marginwidth="0" onLoad="javascript: listar_repartidores_fin_carga();">
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Cargas del día 
      <hr>
    </div></td>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0"> 
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFBFBF">
          ...
          <tr>
            <td width="265" align="left" valign="bottom">Repartidor:</td>
            <td width="836" align="left"valign="bottom"><div id="repartidores"> </div></td>
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar" type="button" class="botones" id="enviar" onclick="javascript: finalizar_carga()"  value="Finalizar Carga">
            </div></td>
            <td width="83" valign="top">&nbsp;</td>
          </tr>
        </table></td>
