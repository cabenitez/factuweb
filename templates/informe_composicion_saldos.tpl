...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Composición de Saldos
        <hr>
    </div></td>
      ...
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <tr>
            ...
            <td width="145" align="left" valign="top">       <input name="codigo" type="text" class="caja" id="codigo" onKeyPress="return solo_entero(event)" onKeyUp="informe_compras_cliente_1(event)" size="12" maxlength="9" >
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="buscar" type="button" class="botones" id="buscar" onClick="javascript: buscar_composicion_saldo_cliente()"  value="Buscar">
</div></td>
