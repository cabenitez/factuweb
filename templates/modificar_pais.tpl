...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
	...
	<div align="left"> Modificar Pais <hr width="100%"> </div></td>
  </tr>
  <tr>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFBFBF">
          <tr>
            <td width="18" height="19" rowspan="4" valign="top"><span class="DDD"><img src="../imagenes/18.jpg" width="18" height="18" /></span></td>
          ...
          <tr>
            <td width="12" align="left" valign="bottom"><div align="left">Pais:
            </div></td>
            <td width="151" align="left"valign="bottom">
              <input name="nombre_mod" id="nombre_mod" type="text" class="caja" size="27" onKeyUp="pasar_foco_pais_mod(event)" value="{$nombre}" >              </td>
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar_mod" type="button" class="botones" id="enviar_mod" onclick="javascript: modificar_pais_db()"  value="Modificar">
                <input name="cancelar_mod" type="button" class="botones" id="cancelar_mod" onclick="javascript: buscar_pais()"  value="Cancelar">
            </div></td>
            <td width="18" valign="top">&nbsp;</td>
          </tr>
        </table></td>
