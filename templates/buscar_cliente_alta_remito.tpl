...
<center>
<body  leftmargin="0" topmargin="0"  marginheight="0" marginwidth="0" onLoad="javascript:document.frm.codigo.focus();listar_loca_buscar_alta_rem();">
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="100%" height="21" class="seccion" valign="top"><div align="left">Buscar Cliente
        <hr>
    </div></td>
  </tr>
  <tr>
        ...
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          ...
          <tr>
            ...
            <td width="331" align="left" valign="bottom">
                ...
                <input name="codigo" type="text" class="caja" id="codigo" onKeyPress="return solo_entero(event)" onKeyUp="pasar_foco_rem_vta_bus_1(event)" size="12" maxlength="9" >             </td>
            <td width="115" align="left"valign="top"></td>
          </tr>
          <tr>
            <td align="left" valign="bottom"><div align="left"> Razon Social:</div></td>
            <td align="left" valign="bottom">
			<input name="razon" type="text" class="caja" id="razon" onKeyUp="pasar_foco_rem_vta_bus_2(event)" size="29" ></td>
            <td valign="top"></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar" type="button" class="botones" id="enviar" onclick="javascript: listar_loca_buscar_alta_rem2()"  value="Buscar">
            </div></td>
