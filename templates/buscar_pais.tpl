	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFBFBF">
          ...
          <tr>
            <td width="12" valign="top"><div align="left">Pais:<br>
            </div></td>
            <td width="151" align="left"valign="top">
              <input name="nombre" id="nombre" type="text" class="caja" size="27" onKeyUp="pasar_foco_pais_buscar(event)" >
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                <input type="hidden"  id="oculto3" name= "oculto" >
                <!-- campo oculto-->
                <input name="enviar" type="button" class="botones" id="enviar" onclick="javascript: buscar_pais()"  value="Buscar">
            </div></td>
            <td width="18" valign="top">&nbsp;</td>
          </tr>
        </table></td>
