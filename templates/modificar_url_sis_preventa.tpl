...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Modoficar Direccion Sistema Preventa  
      <hr>
    </div></td>
        ...
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFBFBF">
          ...
          <tr>
            ...
            <td width="778" align="left"valign="bottom">http://
              <input name="nombre" id="nombre" type="text" class="caja_min" size="80" title="ejemplo: http://www.sistema-preventa.com"onKeyUp="pasar_foco_pais_registrar(event)" value="{$url}"></td>
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar" type="button" class="botones" id="enviar" onclick="javascript: registrar_url_sis_preventa()"  value="Modificar">
            </div></td>
            <td width="18" valign="top">&nbsp;</td>
          </tr>
        </table></td>
