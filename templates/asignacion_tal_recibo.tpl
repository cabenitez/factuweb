...
<center>
<body  leftmargin="0" topmargin="0"  marginheight="0" marginwidth="0" onLoad="javascript: buscar_cliente_cta_cte_asig_tal();">
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0"><!--DWLayoutTable-->
  <tr>
	...
	<div align="left">Seccion: Asignaci&oacute;n de Talonarios<hr></div></td>
...
-->	
   ...
   <tr>
    <td colspan="2" align="center" valign="top">
		<div  class="advertencia" id="msg"  ></div>
		<div id="listado"></div>
		<!-- -->
	</td>
  </tr>
