...
<body leftmargin="0" topmargin="0"  marginheight="0" marginwidth="0" onLoad="javascript: document.frm.remito.focus();listar_proveedores_fact_compra(); hora_actual();"> <!-- listar_zona_fac(); listar_cond_iva_fac();listar_cat_fac();listar_forma_pago(); -->
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0"><!--DWLayoutTable-->
  <tr>
	...
	<img src="../imagenes/imprimir.png" width="18" height="18" title="Imprimir Factura... (F9)" class='iconos' onClick="javascript: registrar_factura_vta();" /> imprimir<hr></td>
      ...
      <tr>
		...
		<table width="100%" border="0" align="left" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          <tr>
            ...
            <td height="18" colspan="13" valign="top"><div id="mensaje" class="advertencia"></div></td>
          ...
          <tr>
            ...
            <td width="43"  align="left" valign="bottom" >Remito:</td>
            <td width="93"  align="left" valign="bottom"class="seccion" ><input  name="remito" type="text"class="select_1"  id="remito" onKeyPress="return solo_entero(event)" onKeyUp="buscar_remito_alta_factura_compra(event)" size="8" maxlength="8">
