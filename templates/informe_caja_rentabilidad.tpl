...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Caja / Rentablidad
        <hr>
    </div></td>
...
<fieldset  style="width:25%; height:10%;">
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          <tr>
            <td width="36" height="19" rowspan="5" valign="top" class="LLL"><span class="DDD"><img src="../imagenes/18.jpg" width="18" height="18" /></span></td>
          ...
          <tr>
            <td width="350" align="left" valign="bottom">Fecha desde: </td>
            <td width="825"align="left"   valign="bottom">
  ...
  <input name="dia2" type="text" class="caja" id="dia_h"onKeyUp="informe_compras_cliente_4(event)" onKeyPress="return solo_entero(event)"value="" size="2" maxlength="2">
  /
  <input name="mes2" type="text" class="caja" id="mes_h"onKeyUp="pasar_foco_iva_ventas_5(event)" onKeyPress="return solo_entero(event)"value="" size="2" maxlength="2">
  /
  <input name="ano2" type="text" class="caja" id="ano_h"onKeyUp="pasar_foco_iva_ventas_6(event)" onKeyPress="return solo_entero(event)"value="" size="4" maxlength="4">
            <td valign="top"></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="buscar" type="button" class="botones" id="buscar" onClick="javascript: informe_caja_rentabilidad_proceso()"  value="Buscar">
</div></td>
