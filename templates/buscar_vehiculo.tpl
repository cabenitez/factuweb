...
<center>
<body  leftmargin="0" topmargin="0"  marginheight="0" marginwidth="0" onLoad="javascript: document.frm.marca.focus()">
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="21" class="seccion" valign="top"><div align="left">Seccion: Buscar Vehículo
        <hr>
    </div></td>
    <td width="50%" align="right" valign="top" class="seccion">
	<img src="../imagenes/nuevo2.gif" width="16" height="18" border="0" class='iconos'  title="Nuevo" onClick=" window.opener.document.getElementById('principal').src ='alta_vehiculo.php'" /> nuevo &nbsp;&nbsp;
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="2" bordercolor="#BFBFBF">
          <tr>
            <td width="79" height="19" rowspan="5" valign="top" class="LLL"><span class="DDD"><img src="../imagenes/18.jpg" width="18" height="18" /></span></td>
          ...
          <tr>
            ...
            <td width="586" align="left" valign="top">
                ...
                <input name="marca" type="text" class="caja" id="marca" onKeyUp="pasar_foco_vehi_10(event)" >             </td>
            <td width="115" align="left"valign="top"></td>
          </tr>
          <tr>
            <td valign="bottom"align="left"> Repartidor:</td>
            <td align="left" valign="bottom">
			<input name="chofer" type="text" class="caja" id="chofer" onKeyUp="pasar_foco_vehi_11(event)" ></td>
            <td valign="top"></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" valign="bottom"><div align="center">
                ...
                <!-- campo oculto-->
                <input name="enviar" type="button" class="botones" id="enviar" onclick="javascript: buscar_vehiculo2()"  value="Buscar">
            </div></td>
